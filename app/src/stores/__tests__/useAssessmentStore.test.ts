...
describe('useAssessmentStore', () => {
  ...
  describe('updateResponse', () => {
    it('should update a single response', () => {
      ...
      updateResponse('peak_energy_times', ['morning']);

      const state = useAssessmentStore.getState();
      expect(state.responses.peak_energy_times).toEqual(['morning']);
    ...
    it('should update multiple responses independently', () => {
      ...
      updateResponse('peak_energy_times', ['morning', 'afternoon']);
      updateResponse('energy_consistency', 3);

      const state = useAssessmentStore.getState();
      expect(state.responses.peak_energy_times).toEqual(['morning', 'afternoon']);
  ...
  describe('getResponses', () => {
    it('should return current responses', () => {
      ...
      expect(responses.peak_energy_times).toEqual(['morning']);
