/**
 * @file src/components/shared/icons/UploadIcon.tsx
 * @purpose Upload/import icon for file upload actions
 * @functionality
 * - Renders an upward arrow with platform base SVG icon
...
/**
 * Upload Icon
 * Used for import/upload file actions in menus and buttons
 */
