/**
 * @file src/components/shared/icons/GitHubIcon.tsx
 * @purpose GitHub brand icon for social/repository links
 * @functionality
 * - Renders the GitHub logo SVG icon
...
/**
 * GitHub Icon
 * Used for GitHub repository links and social media references
 */
